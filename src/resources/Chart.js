...
export default class SomeChartLib {
    ...
    draw() {
        if (this.chartObj) {
            ...
            this.chartObj.options.scales.xAxes[0].time.unit = moment.duration(this._max.diff(this._min)).asDays() > 2 ? 'day' : 'hour'
                ...
                scales: {
                    ...
                    xAxes: [{
                        ...
                        time: {
                            ...
                            unit: moment.duration(this._max.diff(this._min)).asDays() > 2 ? 'day' : 'hour'
                        }
                    }]
                }
            }
